    ...
    return (
        <div>
            <ul className="flex gap-3 font-bold">
                <li className={router.pathname == "/create-token" ? " text-yellow-500 font-bold" : ""}>

                    <Link href="/create-token">Create Token</Link>
                </li>
                <li className={router.pathname == "/" ? " text-yellow-500 font-bold" : ""}>

                    <Link href="/">Pool Staking</Link>
                </li>
                <li className={router.pathname == "/pool-swap" ? " text-yellow-500 font-bold" : ""}>
